...
System.out.println(bio2019.canSubstituteFor(bio2019, bio2015));
System.out.println(bio2015.canSubstituteFor(bio2015, bio2019));
 
Textbook math = new Textbook("Calculus", 45.25, 1);
 
System.out.println(bio2015.canSubstituteFor(math, bio2015));
    };
}
